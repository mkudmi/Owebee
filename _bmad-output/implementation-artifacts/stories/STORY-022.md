...
This story intentionally avoids CRDT and full event sourcing. It validates the architecture decision from `_bmad-output/planning-artifacts/architecture.md`: client outbox, idempotent server mutations and explicit conflict states.
